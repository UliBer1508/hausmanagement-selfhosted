...
const OriginalDashboard = () => {
  ...
  const { data: bookingsData, isLoading: bookingsLoading } = useQuery({
    ...
    queryFn: async () => {
      // WICHTIG: delta_guests, guest_surcharge_amount und guests_changed_at
      ...
      //  - delta_guests ist die eingefrorene "vorher"-Gaestezahl. Ohne sie
      //    rechnet CreateBookingForm.tsx (baselineGuests, ~Z.150) mit der
      //    AKTUELLEN Zahl, und persistCharges() ueberschreibt delta_guests bei
      //    jeder Aenderung erneut, obwohl es nur einmal gesetzt werden darf.
      //  - delta_guests + guest_surcharge_amount speisen das Abweichungs-Badge
