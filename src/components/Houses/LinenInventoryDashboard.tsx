...
const LinenInventoryDashboard = ({ house }: LinenInventoryDashboardProps) => {
  ...
  const linenCategories = useMemo((): LinenCategory[] => {
    ...
    const categories = [
      ...
      { key: 'sink_towels', label: 'WB-Handtücher', perGuestKey: null, perBookingKey: 'sink_towels_per_booking' as const },
      { key: 'large_towels', label: 'Badetücher', perGuestKey: 'large_towels_per_guest' as const, perBookingKey: null },
